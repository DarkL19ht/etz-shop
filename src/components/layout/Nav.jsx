...
function Nav() {
  ...
  return (
    <>
      <nav className="mb-5 flex w-[89%] justify-between border-b-2 pb-5">
        <img
          src="../src/assets/Etranzact_Logo.png"
          alt="eTranzact logo"
          className="w-42 h-5 md:h-10 md:w-52"
        />
        <div className="md:text-normal flex w-6/12 justify-between gap-3 px-2 text-xs font-semibold text-white md:w-2/12 md:px-0">
          <button
            type="button"
